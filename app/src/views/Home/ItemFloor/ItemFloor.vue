        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li
              ...
              v-for="(obj, index) in floorObj.navList"
              :key="index"
            >
              <a :href="obj.url" data-toggle="tab">{{ obj.text }}</a>
            </li>
          </ul>
        </div>
      </div>
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(k, index) in floorObj.keywords" :key="index">
                  {{ k }}
                </li>
              </ul>
            ...
            <div class="floorBanner">
              <!-- 轮播图 -->
              <CarouseShow :CarouselObj="floorObj.carouselList"></CarouseShow>
            </div>
            <div class="split">
