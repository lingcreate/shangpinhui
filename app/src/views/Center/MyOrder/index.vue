  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        <table
          class="order-item"
          v-for="(order, index) in OrdersInfo.records"
          :key="order.id"
        >
          <thead>
            <tr>
          ...
          <tbody>
            <tr
              v-for="(good, index) in order.orderDetailList"
              :key="good.skuId"
            >
              <td width="60%">
              ...
              >
                <ul class="unstyled">
                  ...
                  <li v-if="order.paymentWay == 'ONLINE'">在线支付</li>
                  <li v-else>{{ order.paymentWay }}</li>
                </ul>
              </td>
              <!-- 状态 -->
              <td
